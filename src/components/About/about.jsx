      ...
      <div className="row">
        <div className="text-center">
          <div className="col-8 mx-auto">
            ...
            <p>
              Lorem ipsum dolor sits consectetur, adipisicing elit. Repudiandae
              optio eveniet facilis error reiciendis quas molestias culpa
              aliquid quo tenetur, dolore, quis itaque eius ratione ea iusto
              omnis fugiat recusandae.
            </p>
          </div>
        </div>
      </div>
