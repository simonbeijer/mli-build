...
export default class ProductProvider extends React.Component {
  constructor(props) {
    ...
    this.products = [
      {
        src:
          "https://scontent-arn2-2.xx.fbcdn.net/v/t1.0-9/83383352_10213925621047913_158517549154172928_n.jpg?_nc_cat=100&ccb=2&_nc_sid=e3f864&_nc_ohc=CmsuDyeaftAAX9JxOEk&_nc_ht=scontent-arn2-2.xx&oh=f09142ce1b070ace3337e44614cabd9f&oe=5FCB7F4E",
        alt: "test",
        name: "Jerk Bait 2000",
        available: "AVAILABLE",
      },
